...
4. REFERENCE FIREWALL。
5. CANONICAL WORLD RULES。
6. SPATIAL REVISION / LOC_VIEW / WORLD PLACEMENT LOCK。
7. CAMERA AUTHORITY与VIEW COVERAGE。
8. CAMERA REVEAL ENVELOPE / VISUAL COVERAGE REQUIREMENT。
9. KEYFRAME EXECUTION。
10. MODEL-NATIVE TRANSITION CONTRACTS。
11. ACTION / EDIT TRANSITION。
12. CONTINUITY & TEMPORAL LOCK。
13. OUTPUT FORMAT。
