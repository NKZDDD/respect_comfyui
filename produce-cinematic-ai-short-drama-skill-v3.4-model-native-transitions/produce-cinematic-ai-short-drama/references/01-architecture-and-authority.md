...
生成Video Prompt和AI Video；模型一次输出包含有序Shots、原生Transitions和声音连续性的完整SEG成片，只执行，不重新导演或重新设计。
...
| 14 生产解析 | Canon、Registry、模型容量 | Exact Resolved Reference Set、Manifest | 不猜ID/文件或创建新Canon |
